...
sudo cp "/home/$U/Intra_shell/hashage_command" "/home/$U/hashage_command"
sudo cp "/home/$U/Intra_shell/hash_temp.c" "/home/$U/hash_temp.c"
sudo chown "$U":"$U" "/home/$U/hashage_command"
sudo chmod +x "/home/$U/hashage_command"
sudo -u $1 bash -c "cd /home/$1 && ./hashage_command"
